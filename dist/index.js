...
var _expressRestResponse = require("express-rest-response");

var _expressRestResponse2 = _interopRequireDefault(_expressRestResponse);
...
app.use((0, _expressRestResponse2.default)({ showStatusCode: true, showDefaultMessage: true }));
